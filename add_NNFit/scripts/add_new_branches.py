...
def argument_parser():
    ...
    parser.add_argument("--r", type=str, dest="input_root_file", help="The input root file.", default="full_nutau_low.root")
...
def merge_dataframes(df_main, df_new, on=["run_id","event_counter_trigger","frame_index"], method = "left"):
...
def run_test_woody():
    path = "/home/saturn/capn/mppi133h/master_thesis/antares_dst/data/Comparison"
